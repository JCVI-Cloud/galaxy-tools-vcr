...
_magic_number = 5
_modified_time = 1292435049.196595
_template_filename='templates/workflow/editor_generic_form.mako'
    ...
    try:
        ...
        if form.inputs:
            ...
            for input in form.inputs:
                ...
                __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin()[__M_key]) for __M_key in ['cls'] if __M_key in __M_locals_builtin()]))
                # SOURCE LINE 12
                __M_writer(u'\n                  <div class="')
                # SOURCE LINE 13

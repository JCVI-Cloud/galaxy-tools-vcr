...
_magic_number = 5
_modified_time = 1292349249.0419569
_template_filename='templates/workflow/editor_tool_form.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_locals.update(__M_dict_builtin([(__M_key, __M_locals_builtin()[__M_key]) for __M_key in ['RuntimeValue','ExpressionContext','DataToolParameter'] if __M_key in __M_locals_builtin()]))
        # SOURCE LINE 4
        __M_writer(u'\n\n')
        # SOURCE LINE 45
        __M_writer(u'\n\n')
        ...
        # SOURCE LINE 97
        __M_writer(unicode(h.url_for( action='editor_form_post' )))
